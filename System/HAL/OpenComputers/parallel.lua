--[[
    ...
    https://github.com/cc-tweaked/CC-Tweaked/blob/mc-1.20.x/projects/core/src/main/resources/data/computercraft/lua/rom/apis/parallel.lua
...
local function runUntilLimit(_routines, _limit)
    ...
    while true do
        ...
        eventData = table.pack(System.EventEmitter.PullRaw())
    end
end
...
Internal.Native.parallel = copy(parallel)